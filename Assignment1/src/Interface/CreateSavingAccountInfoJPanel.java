 ...
 * @author 徐涛
 */
public class CreateSavingAccountInfoJPanel extends javax.swing.JPanel {

    /**
     * Creates new form CreateSavingAccountInfoJPanel
     */
    Person person = new Person();
    public CreateSavingAccountInfoJPanel(Person person) {
        initComponents();
        this.person = person;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Create Saving Account");
    ...
    private void createBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createBtnActionPerformed
        ...
        SavingAccountInfo sAF = new SavingAccountInfo();
        sAF.setBankName(bankNameTextField.getText());
        sAF.setBankRoutingNum(bankRountingNumTextField.getText());
        sAF.setBankAccountNum(bankAccountNumTextField.getText());
        sAF.setAccountBalance(accountBalanceTextField.getText());
        sAF.setAccountType(accountTypeTextField.getText());
        this.person.setSavingAccountInfo(sAF);
